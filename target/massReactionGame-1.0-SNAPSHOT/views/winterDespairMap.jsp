...
<head>
    ...
    <style>
        ...
        #showWinterDespairMap
        {
            position: absolute;
            background-image: url("/resources/maps/winterDespairMap.png");
            width: 800px;
            height: 600px;
        ...
        #snowmanMonsters,#iceCastleMonsters,#yetiMonsters,#iceZombieMonsters
        {
            position: absolute;
            width: 60px;
            height: 60px;
        }
        #snowmanMonsters:hover,#iceCastleMonsters:hover,#yetiMonsters:hover,#iceZombieMonsters:hover
        {
            cursor: pointer;
        }
        #snowmanMonsters
...
<div id="container">
    <div id="sideMenu"  style="left:50%;margin-left: -660px"><%--zeby bylo w tym samym miejscu co mapa na innej stronie--%>
        <ul id="sideList">
            ...
            <li class="sideMenuLi" id="currentMap"><a href="/showMapWinterDespair">Zimowa Rozpacz</a></li>
        </ul>
    </div>

    <div id="showWinterDespairMap">
        <div id="relativeContentOfMap" style="position: relative;width: 100%;height: 100%">
            ...
            <img id="snowmanMonsters" src="/resources/pageElements/attackMonsterClick.png">
            <img id="iceCastleMonsters" src="/resources/pageElements/attackMonsterClick.png">
            <img id="yetiMonsters" src="/resources/pageElements/attackMonsterClick.png">
            <img id="iceZombieMonsters" src="/resources/pageElements/attackMonsterClick.png">
